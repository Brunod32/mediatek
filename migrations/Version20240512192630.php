...
final class Version20240512192630 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE band (id INT AUTO_INCREMENT NOT NULL, country_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, picture LONGTEXT DEFAULT NULL, kind_of_metal VARCHAR(255) DEFAULT NULL, creation_year INT DEFAULT NULL, INDEX IDX_48DFA2EBF92F3E70 (country_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
